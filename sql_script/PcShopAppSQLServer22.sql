...
/****** Object:  Database [PcShop]    Script Date: 6/24/2024 6:17:02 PM ******/
CREATE DATABASE [PcShop]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PcShop', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\PcShop.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'PcShop_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\PcShop_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [PcShop] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [PcShop] SET RECOVERY SIMPLE 
GO
...
ALTER DATABASE [PcShop] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [PcShop] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [PcShop] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO

ALTER DATABASE [PcShop] SET QUERY_STORE = OFF
GO
